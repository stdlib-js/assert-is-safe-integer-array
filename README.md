...
```javascript
import isSafeIntegerArray from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-safe-integer-array@v0.2.2-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { objects, primitives } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-safe-integer-array@v0.2.2-deno/mod.js';
```
